...
model = dict(
    type='CascadeRCNN',
    pretrained='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_small_patch4_window7_224.pth',#None,
    backbone=dict(
...
runner = dict(type='EpochBasedRunnerAmp', max_epochs=36)#dict(type='EpochBasedRunnerAmp', max_epochs=36)
checkpoint_config = dict(interval=1)
log_config = dict(interval=20, hooks=[dict(type='TextLoggerHook')])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = './work_dirs/cascade_swin_s/epoch_36.pth'#None
resume_from = None
workflow = [('train', 1)]
fp16 = None#dict(loss_scale=dict(init_scale=512))
work_dir = './work_dirs/cascade_swin_s'
gpu_ids = [3]
